...
{
    public partial class editconcepteur : Form
    {
        int id;
        OleDbConnection connection = new OleDbConnection();
        public editconcepteur(int id)
        {
            InitializeComponent();
            this.id = id;
...
Persist Security Info=False;";
        ...
        private void editconcepteur_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                OleDbCommand command = new OleDbCommand();
                command.Connection = connection;
                query = "select * from Concepteur where id = " + id;
        ...
        private void b1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                query = "update Concepteur set [username] = '" + username.Text + "', [full_name] ='" +
                    full_name.Text + "',[tel]= '" + phone.Text + "' , [email] ='" +
                    email.Text + "'," +
                    " [adresse] = '" + adresse.Text + "'   where id = " + id;
                command.CommandText = query;
